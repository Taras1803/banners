    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <select class="form-control" name="board[type]">
                                        <option value="0">Не указан</option>
                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <select class="form-control input-sm input-inline" name="board[sitemap]">
                                        <option value="1" <?php if($board->sitemap == 1): ?>selected<?php endif; ?>>Отображать в sitemap</option>
                                        <option value="0" <?php if($board->sitemap == 0): ?>selected<?php endif; ?>>Убрать из sitemap</option>
                                    </select>
                                </div>
                            </div>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea class="form-control" rows="4" name="board[address]"><?= set_value('address', $board->address) ?></textarea>
                        ...
                        <div class="tab-pane" id="tab_side_<?= $side->id ?>">
                            ...
                            <div class="form-body form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10">
                                        <div class="col-md-12 fileinput <?php if(empty($side->image_path)):?>fileinput-new<?php  else:?>fileinput-exists<?php endif;?>" data-provides="fileinput">
                                            <div class="col-md-2 fileinput-preview thumbnail" data-trigger="fileinput">
                                        ...
                                        <div class="col-md-12" id="extra-img-wrap">
                                            <?php foreach($side->extra_imgs as $img): ?>
                                                <div data-id="<?= $img->id ?>" style="background-image:url(<?= $img->small ?>)">
                                                    <div class="delete"></div>
                                                </div>
                                            <?php endforeach;?>
                                        </div>
                                        <input type="file" data-side="<?= $side->id ?>" id="extra-img" style="display:none;">
                                        <label for="extra-img" id="extra-img-label" class="btn fileinput-exists">Загрузить доп. изображение</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <select class="form-control" name="sides[<?= $side->id ?>][is_changing]">

                                            <option <?= $side->is_changing == '' ? 'selected' : '' ?> value="">-</option>
                                            <option <?= $side->is_changing == 'статика' ? 'selected' : '' ?> value="статика">статика</option>
                                            <option <?= $side->is_changing == 'динамика' ? 'selected' : '' ?> value="динамика">динамика</option>
            ...
            <div class="buttons-set bottom">
                <button class="btn save">Сохранить</button>
                <a class="btn delete" href="/adm/boards/remove/board/<?= $board->id ?>/">Удалить</a>
